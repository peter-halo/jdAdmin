...
INSERT INTO `admin_rule` (`id`, `name`, `icon`, `c`, `m`, `pid`, `status`, `addtime`, `type`) VALUES 
	(500,'管理员管理','layui-icon-zzuser-secret','','',0,1,'2018-06-19 11:06:21',0),
	(501,'管理员列表',NULL,'userAdmin','index',500,1,'2018-06-19 11:45:09',0),
	(502,'角色管理',NULL,'userAdmin','role',500,1,'2018-06-19 15:14:09',0),
	(503,'权限管理',NULL,'userAdmin','rule',500,1,'2018-06-19 15:20:38',0),
	(504,'权限分类',NULL,'userAdmin','cate',500,1,'2018-06-19 15:26:14',0),
  (200,'运单下单','layui-icon-zzuser-secret','','',0,1,'2018-06-19 11:06:21',0),
  (201,'运单提交',NULL,'booking','index',200,1,'2018-06-19 11:06:21',0),
  (100,'京东账号管理','layui-icon-zzuser-secret','','',0,1,'2018-06-19 11:06:21',0),
  (101,'京东账号列表',NULL,'jdAccount','index',100,1,'2018-06-19 11:06:21',0),
  (102,'添加京东账号',NULL,'jdAccount','add',100,1,'2018-06-19 11:06:21',0),
  (300,'运单查询','layui-icon-zzuser-secret','','',0,1,'2018-06-19 11:06:21',0),
  (301,'运单列表','layui-icon-zzuser-secret','order','index',300,1,'2018-06-19 11:06:21',0);
...
INSERT INTO `admin_user` (`id`, `roleid`, `username`, `password`, `phone`, `email`, `status`, `addtime`, `ip`) VALUES 
	(1,1,'admin','e10adc3949ba59abbe56e057f20f883e','18888888888','gmail@gmail.com',1,'2018-06-13 16:02:24','');
