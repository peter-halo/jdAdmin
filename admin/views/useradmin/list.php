...
<body>
    <div class="x-body">
        ...
        <xblock>
            <button class="layui-btn" onclick='x_admin_show("添加角色","<?=$this->config->item('index_page').'?c=userAdmin&m=addUser'?>",600,600)'>
            ...
            <?php foreach($list as $val){ ?>
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <?php } ?>
                        <a title="编辑"  onclick='x_admin_show("编辑","<?=$this->config->item('index_page').'?c=userAdmin&m=editUser&uid='.$val['id']?>",500,600)' href="javascript:;">
